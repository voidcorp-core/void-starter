...
Status: approved and created in Linear on 2026-07-26.

Linear project: [Void Starter](https://linear.app/voidcorp/project/void-starter-35501cdfd58b)
(`e593ab7d-2c0d-45ad-8810-828fe76aa022`). Linear is authoritative for live issue status; this
file records the approved structure and identifiers.
...
1. **DEV-467 — Implement the Cloudflare R2 adapter**
...
2. **DEV-466 — Implement the Sentry provisioning adapter**
...
3. **DEV-468 — Implement the PostHog provisioning adapter**
...
4. **DEV-469 — Implement the DNS adapter**
...
5. **DEV-470 — Design the guarded EAS environment and native-build lifecycle**
...
11. **DEV-476 — Connect Forge as the manifest producer**
...
12. **DEV-477 — Implement Linear project bootstrap**
